...
**Include:** System architecture diagram (pipeline flowchart) and `reports/figures/correlation/01_sensor_stress_correlation.png` to illustrate initial context over self-reported EMA stress peaks.
